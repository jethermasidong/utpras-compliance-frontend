<template>
  <div class="p-6 md:p-10 max-w-7xl mx-auto">
    ...
    <div class="mb-10">
      <h1 class="text-3xl font-bold text-gray-900">MCC Application</h1>
    ...
    <div class="space-y-8">
      ...
      <div class="flex justify-end mb-10">
        <button @click="addMCCApplication" class="px-5 py-3 bg-blue-900 text-white font-bold rounded-2xl shadow-lg hover:bg-blue-800 transition-all transform hover:-translate-y-1">
          Submit Application
        </button>
      </div>
    </div>
...
import { createMCCProfile } from '../../api/mccProfile.js';
...
const isNumber = (key) => ['telephone', 'duration', 'no_of_trainees', 'no_of_batches'].includes(key);
...
const addMCCApplication = async () => {
  ...
  try { 
    ...
    const response = await createMCCProfile(data);
