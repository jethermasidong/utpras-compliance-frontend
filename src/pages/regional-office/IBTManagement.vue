  <template>
    <div class="p-6 md:p-10 max-w-7xl mx-auto">
      ...
      <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">IBT Program Requirements</h1>
        <button 
  ...
  import { viewRequirement, createRequirements, editRequirements, deleteRequirement} from '../../api/ibtApi.js';
