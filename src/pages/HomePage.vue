<template>
  <div 
    class="w-screen relative left-[calc(-63vw+60%)] min-h-[90vh] flex justify-center items-center bg-cover bg-center py-12 px-4 -my-10"
    style="background-image: url('https://filipinotimes.net/wp-content/uploads/2020/01/TESDA-Training-for-OFW.jpg');"
  >
    <div class="absolute inset-0 bg-gray-900/60 backdrop-blur-lg"></div>
    
    <div class="relative z-10 w-full max-w-4xl bg-white/95 flex flex-col lg:flex-row rounded-2xl shadow-2xl overflow-hidden min-h-120">
      
      <div class="hidden lg:flex lg:w-1/2 flex-col justify-center border-r border-gray-200 px-12 lg:px-16 py-20 bg-gray-50/50">
        <span class="inline-block text-xs font-semibold tracking-widest text-blue-700 uppercase mb-4">
          TESDA
        </span>
        ...
        <div class="mt-10 space-y-4">
          <div class="flex items-start gap-3">
            ...
            <p class="text-sm text-gray-800 font-medium">Track requirement status across programs in real time.</p>
          </div>
          <div class="flex items-start gap-3">
            <span class="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-600 shrink-0"></span>
            <p class="text-sm text-gray-800 font-medium">Role-based dashboards for regional and provincial teams.</p>
          </div>
        </div>
      </div>
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input
                  v-model="email"
                  type="email"
                  class="w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition bg-white"
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input
                  ...
                  class="w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition bg-white"
                  placeholder="••••••••"
                  required
                />
                <button
